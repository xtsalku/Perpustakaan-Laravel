...
<body>
    ...
    <div id="content">
        ...
        <form action="http://localhost:8000/admin/list-peminjam" method="GET">
        <label for="cari">Cari : 
            <input type="text" id="cari" name="cari" placeholder="cari berdasar nama" value="{{ isset($searchTerm) ? $searchTerm : '' }}">
        </label>
